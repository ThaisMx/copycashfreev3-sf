...
export default function AlternativaPage() {
  return (
    <div className="flex flex-col items-center min-h-screen bg-black text-white p-4 max-w-md mx-auto">
      ...
      {/* Botão de ação */}
      <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-md text-lg mb-4 hiperlead">
        ENTRAR NO GRUPO
      </Button>
